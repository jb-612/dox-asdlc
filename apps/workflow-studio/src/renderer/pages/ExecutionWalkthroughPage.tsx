  ...
  return [
    {
      ...
      data: {
        label: 'Unit Test',
        agentType: 'utest' as AgentNodeType,
    ...
    },
    {
      ...
      data: {
        label: 'Coder',
        agentType: 'coding' as AgentNodeType,
    ...
    },
    {
      ...
      data: {
        label: 'Reviewer',
        agentType: 'reviewer' as AgentNodeType,
 ...
 *
 * Reads from mock execution state (will use executionStore when implemented).
 */
