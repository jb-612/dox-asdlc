...
- [ ] Estimate: 30min
- [ ] Tests: TypeScript compiles; existing CLI tests unaffected
- [ ] Dependencies: None
...
- [ ] Estimate: 1hr
- [ ] Tests: Unit test: mock `execFile('docker', ['version'])` success/failure paths
- [ ] Dependencies: T01
...
- [ ] Estimate: 2hr
- [ ] Tests: Unit test with mocked node-pty; integration test if Docker available
...
- [ ] Estimate: 1hr
- [ ] Tests: Unit tests: add entry, list, clear, ring buffer at max=50, persistence
- [ ] Dependencies: T01
...
- [ ] Estimate: 30min
- [ ] Tests: TypeScript compiles; manual IPC test
...
- [ ] Estimate: 2hr
- [ ] Tests: Component renders; mode toggle switches fields; context fields validated
...
- [ ] Estimate: 1hr
- [ ] Tests: Clicking preset fills form correctly
- [ ] Dependencies: T07
...
- [ ] Estimate: 30min
- [ ] Tests: Clear button resets xterm buffer; cliStore output buffer emptied
- [ ] Dependencies: None
...
- [ ] Estimate: 1.5hr
- [ ] Tests: Panel renders history entries; re-run opens pre-filled SpawnDialog; clear works
...
- [ ] Estimate: 1hr
- [ ] Tests: Unit test — buffer caps at configured max (e.g., 1MB); excess output is dropped with warning; no OOM on long-running container output
- [ ] Dependencies: T04
...
- [ ] Estimate: 30min
- [ ] Tests: Grep all task files for old channel names; none found
- [ ] Dependencies: None
...
- [ ] Estimate: 30min
- [ ] Tests: TypeScript compiles; handler returns `{ available: boolean, version?: string }`
...
- [ ] Estimate: 1hr
- [ ] Tests: Unit test — session summary includes tool call count, files modified list, exit status; summary persisted in history JSON
- [ ] Dependencies: T05
...
- [ ] Estimate: 1.5hr
- [ ] Tests: Full spawn→output→kill→history cycle for both modes; Docker smoke test if available
- [ ] Dependencies: T04, T06, T07, T09, T10
