...
- [ ] Estimate: 1hr
- [ ] Tests: TypeScript compiles with no errors; existing consumers still typecheck
- [ ] Dependencies: None
- [ ] Agent: frontend
- [ ] Notes:
...
- [ ] Estimate: 30min
- [ ] Tests: TypeScript compiles; no runtime test needed (declarations only)
- [ ] Dependencies: T01
- [ ] Agent: frontend
- [ ] Notes:
...
- [ ] Estimate: 1.5hr
- [ ] Tests: Unit tests for setKey/getKey/hasKey/deleteKey; mock safeStorage; test graceful
...
- [ ] Estimate: 1hr
- [ ] Tests: Unit tests for load/save with new `providers` field; verify defaults merge correctly;
...
- [ ] Estimate: 1.5hr
- [ ] Tests: Unit tests for each of 5 new handlers: set-api-key, delete-api-key, get-key-status,
...
- [ ] Estimate: 1hr
- [ ] Tests: Renders 3 tabs; keyboard navigation works; selected tab highlights
...
- [ ] Estimate: 2hr
- [ ] Tests: Renders all 4 provider variants; key field masked; Save Key calls IPC; Test button
...
- [ ] Estimate: 1hr
- [ ] Tests: Temperature clamped to [0.0, 1.0]; max tokens clamped to [1, 200000]; context window
...
- [ ] Estimate: 1hr
- [ ] Tests: Browse buttons call `DIALOG_OPEN_DIRECTORY`; agent timeout clamped to [30, 3600];
      all fields persist
- [ ] Dependencies: T06
- [ ] Agent: frontend
- [ ] Notes:
...
- [ ] Estimate: 30min
- [ ] Tests: Renders version strings from IPC response
- [ ] Dependencies: T05
- [ ] Agent: frontend
- [ ] Notes:
...
- [ ] Estimate: 30min
- [ ] Tests: Warning banner visible when `encryptionAvailable: false` in key status response
...
- [ ] Estimate: 1hr
- [ ] Tests: Unit test — loading settings without `providers` key migrates to default providers;
...
- [ ] Estimate: 15min
- [ ] Tests: TypeScript compiles; handler returns `{ appVersion, electronVersion, nodeVersion }`
- [ ] Dependencies: T02
- [ ] Agent: frontend
- [ ] Notes:
...
- [ ] Estimate: 1hr
- [ ] Tests: Unit test — `getConfiguredProviders()` returns only providers with stored API keys;
...
- [ ] Estimate: 1.5hr
- [ ] Tests: Existing settings round-trip (load/save with legacy fields); new providers round-trip;
      all 5 new IPC handlers tested end-to-end with Electron test harness or vitest mocks
- [ ] Dependencies: T01–T11, T13, T14, T15
- [ ] Agent: frontend
- [ ] Notes:
